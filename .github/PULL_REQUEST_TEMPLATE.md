...
- [ ] **Story `State:` set to `Done`, and the matching row in `stories/README.md` updated to `Done`**
      — this is the one that has slipped twice already; check it before merging, not after
